...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { long_description: @magazine.long_description, price: @magazine.price, short_description: @magazine.short_description, status: @magazine.status, title: @magazine.title, user: @magazine.user }
    end
  ...
  test "should update magazine" do
    patch :update, id: @magazine, magazine: { long_description: @magazine.long_description, price: @magazine.price, short_description: @magazine.short_description, status: @magazine.status, title: @magazine.title, user: @magazine.user }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
