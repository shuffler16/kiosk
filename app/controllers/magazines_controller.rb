class MagazinesController < ApplicationController
  ...
  before_action :valid_status, only: [:new, :edit]
  ...
  private
    ...
    def magazine_params
      params.require(:magazine).permit(:user, :title, :short_description, :long_description, :status, :price)
    end

  def valid_status
    @valid_status = %w(DRAFT SUBMITTED REVIEW PUBLISHED)
  end
end
